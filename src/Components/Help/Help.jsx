export function Help({func}) {
    ...
    return (
        <div className='help-screen'>
            ...
            <div className='body-text'>Drag cards onto valid spaces on the board. Placing cards on top of other cards grants points based on the values of each card. Circle cards grant no points.</div>
